-- Workaround approach: Create user with existing role, then update
-- Run this in your Supabase SQL editor

-- Step 1: Add 'magasinier' to the enum
ALTER TYPE user_role ADD VALUE 'magasinier';

-- Step 2: Create user with existing role first (e.g., 'conducteur')
INSERT INTO public.users (
  ...
  'CGI',
  '0123456789',
  'conducteur',  -- Use existing enum value temporarily
  NOW(),
  NOW()
